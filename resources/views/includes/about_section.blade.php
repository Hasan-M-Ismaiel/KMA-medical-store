     ...
     <div class="container">
         ...
         <div class="row gy-4">
             ...
             <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="200">
                 ...
                 <p class="fst-italic">
                     KMA.care operates under strict UAE government regulations and holds strong licensing for pharmaceutical import, export and distribution.
                 ...
                 <ul>
                     <li><i class="bi bi-check2-all"></i> <span>Fully licensed and regulated.</span></li>
                 ...
                 <p>
                    Key Medical Aid (KMA.care) is a UAE-licensed medical store specializing in pharmaceutical import, storage, export, and distribution
                 </p>
             </div>
         </div>
